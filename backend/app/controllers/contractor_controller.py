# backend/app/controllers/contractor_controller.py
import bcrypt
import uuid
import re
import json
...
class ContractorController:
    ...
    @staticmethod
    def signup(data):
        print("🔵 ContractorController.signup received:", data, type(data))

        brn = (
            data.get('business_registration_number') or
        ...
        missing = []
        if not brn:
            missing.append("business_registration_number")
        if not company_name:
        ...
        if missing:
            # This will now show in your frontend instead of generic text
    ...
    def update_company_bank(form_data, files):
        ...
        send_email(
            ...
            "Your bank details have been successfully submitted and are stored securely."
        )
